...
final class StyleController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager): JsonResponse
    {
        ...
        $profile = new Profile();
        $profile->setDescription('Un perfil musical');
        $profile->setPhoto('default.jpg');

        // Asociar el perfil al estilo
        $style->addProfile($profile);

        // Persistir la entidad de Style y Profile en la base de datos
